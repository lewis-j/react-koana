            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    entries.forEach((entry) => {
                        const { isIntersecting, target, intersectionRatio } =
                            entry;
                        if (isIntersecting) {
                            observer.unobserve(entry.target);
                            if (
                                target.dataset.anim === animationNames.GALLERY
                            ) {
                                setIsGalleryVisible(true);
                            }
                            if (
                                target.dataset.anim === animationNames.CAROUSEL
                            ) {
                    ...
                    <div className={stylesLocation.contentContainer}>
                        <div className={stylesLocation.content}>
                            ...
                            <p className={stylesLocation.message}>
                                We are located at the heart of old Mountain View
                                Village, about 20 mins outside of Hilo, and 20
                                mins away from the national park. Come by for a
                                coffee break.
                            </p>
                            <div
